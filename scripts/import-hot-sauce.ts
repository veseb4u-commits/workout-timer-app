...
async function importHotSauceWorkout() {
  console.log('Starting Hot Sauce workout import...')
  ...
  const workout = {
    id: workoutId,
    name: 'Hot Sauce',
    description: 'High-intensity boxing-inspired HIIT workout with strikes and punches',
    type: 'circuit',
    is_time_based: true,
    has_levels: true,
  ...
  try {
    ...
    console.log('\n✅ Hot Sauce workout imported successfully!')
